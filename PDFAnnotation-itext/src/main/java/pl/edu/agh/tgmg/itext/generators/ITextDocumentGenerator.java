...
public class ITextDocumentGenerator implements PdfDocumentGenerator {
    ...
    @Override
    public void generate(Document document, List<? extends PdfDocument> data, DocumentStructure documentStructure) throws GenDocumentException {
...
//        int allSubColumns = 0;
//        for (ColumnHeader h : documentStructure.getPdfElements()) {
...
//        headerDecorator.decorate(table,documentStructure.getPdfElements());
